    ...
    return (
        <div className="sm:w-285 min-w-90 min-h-125 mt-5 mx-auto px-4">
            ...
            <textarea
                ...
                onChange={(e) => setNoteData({ ...noteData, content: e.target.value })}
                placeholder="Enter note content . . ."
                className="mt-3 p-5 w-full min-h-148 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all ease-in-out duration-500 whitespace-pre-wrap"
            />
        </div>
    )
}
